///new_at(object,x,y,arg1,arg2,...)
/*
 * Creates a new component at given position, possibly
   providing additional parameters. These parameters
   are then passed to initialization script, which is
   method "init" of the newly created component.
...
_result = instance_create(argument[1], argument[2], _object);
if (_constructor != -1) {
